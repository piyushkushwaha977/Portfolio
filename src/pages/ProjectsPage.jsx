        ...
        <div className=' w-full h-full overflow-x-hidden '>  
            ...
            <div className=' w-full mx-auto  '>
                  <div className=' w-full md:max-w-4xl lg:max-w-5xl mx-auto'>
                     <h2 className=' mb-16 mt-4  w-fit mx-auto font-bold text-3xl md:text-4xl text-center text-gray-200 border-b-2  border-gray-500 '
                     > MY PROJECTS</h2>
                    {/* SKILLS CATEGORIES */}
                      <div className=' flex flex-col gap-12  md:max-w-2xl mx-2 md:mx-auto'>
                       ...
                       <div className=' flex flex-col '>
                           <div className='w-fit flex gap-1 md:gap-2 items-center justify-center'>
                            <h2 className=' md:pb-3 font-semibold text-lg text-gray-300 md:text-2xl border-b-2 border-red-500'
                          ...
                          <div className=' flex flex-col '>
                           <div className='w-fit flex gap-1 md:gap-2 items-center justify-center'>
                            <h2 className=' md:pb-3 font-semibold text-lg text-gray-300 md:text-2xl border-b-2 border-blue-500
                         ...
                         <div className=' flex flex-col '>
                           <div className='w-fit flex gap-1 md:gap-2 items-center justify-center'>
                            <h2 className=' md:pb-3 font-semibold text-lg text-gray-300 md:text-2xl border-b-2 border-green-500
                            '>  MERN  | FULL STACK PROJECTS</h2>
                           </div>
                            <div className=' mx-1 md:mx-4 '>
                              <Link to={"/project/studynotion"}>
