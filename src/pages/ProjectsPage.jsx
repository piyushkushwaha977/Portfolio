                       ...
                       <div className=' flex flex-col '>
                           ...
                           <RiDashboardHorizontalFill className='flex-nowrap mr-0.5 md:mr-1.5 text-purple-700 text-[22px] md:text-3xl'/>
                            ...
                            <div className=' mx-1 md:mx-4  '>
                              <Link to={"/project/studynotion"}  className='group'>
                               <div className=' group-hover:pl-3 transition-all duration-300 ml-2 md:ml-10 py-4 md:py-4  text-gray-400 hover:text-white font-poppins md:text-2xl   border-b '>
                                StudyNotion an Edtech Platform (LMS)  <GoArrowRight className='inline ml-2 md:ml-6 left-0 '/>
                               </div>
                              </Link>
                              {/* <a href='https://truefeedback.in/ '> */}
                              <Link to={"/project/truefeedback"} className='group'>
                               <div className='group-hover:pl-3 transition-all duration-300 ml-2 md:ml-10 py-4 md:py-3  text-gray-400 hover:text-white font-poppins md:text-2xl border-b '>
                          ...
                          <div className=' flex flex-col '>
                           ...
                           <TbLayoutDashboardFilled className=' flex-nowrap mr-0.5  md:mr-1.5 text-teal-500 text-[22px] md:text-3xl'/>
                            ...
                            <div className=' mx-1 md:mx-4 '>
                              <Link to={"/project/foodfusion"} className=' group'>
                               <div className='group-hover:pl-3 transition-all duration-300 ml-2 md:ml-10 py-4 md:py-4  text-gray-400 hover:text-white font-poppins md:text-2xl   border-b '>
                         ...
                         <div className=' flex flex-col '>
                           ...
                           <MdSpaceDashboard className=' flex-nowrap mr-0.5  md:mr-1.5 text-red-700 text-[22px] md:text-3xl'/>
                            ...
                            <div className=' mx-1 md:mx-4 '>
                              <a href='https://brainwave-ui-three.vercel.app/' className='group'>
                               <div className='group-hover:pl-3 transition-all duration-300 ml-2 md:ml-10 py-4 md:py-4  text-gray-400 hover:text-white font-poppins md:text-2xl   border-b '>
                                Brainwave A.I  Landing Page <GoArrowRight className='inline ml-2 md:ml-6 left-0 '/>
                               </div>
                              </a>
                              <a href='https://next-music-eight.vercel.app/' className='group'>
                               <div className='group-hover:pl-3 transition-all duration-300 ml-2 md:ml-10 py-4 md:py-3  text-gray-400 hover:text-white font-poppins md:text-2xl border-b '>
                                Music App with Aceternity UI   <GoArrowRight className='inline ml-2 md:ml-6 left-0 '/>
                               </div>
                              </a>
                              <a href='https://dark-theme-portfolio-xi.vercel.app/' className='group'>
                               <div className='group-hover:pl-3 transition-all duration-300 ml-2 md:ml-10 py-4 md:py-3  text-gray-400 hover:text-white font-poppins md:text-2xl border-b '>
